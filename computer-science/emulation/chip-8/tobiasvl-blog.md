...
## [Memory](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#memory)
...
## [Font](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#font)
...
## [Display](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#display)
...
## [Stack](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#stack)
...
## [Timers](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#timers)
...
## Keypad[](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#keypad)
...
![Cosmic VIP Keypad](./assets/cosmac-vip-keypad.png)
...
## [Fetch/decode/execute loop](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#fetchdecodeexecute-loop)
...
### [Timing](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#timing)
...
### [Fetch](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#fetch)
...
### [Decode](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#decode)
...
### [Execute](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#execute)
...
## [Instructions](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#instructions)
...
![IBM Logo](./assets/chip-8_ibm_logo.png)
...
### `00E0`: Clear screen[](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#00e0-clear-screen)

This is pretty simple: It should clear the display, turning all pixels off to 0.

### `1NNN`: Jump[](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#1nnn-jump)
...
### `00EE` and `2NNN`: Subroutines[](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#00ee-and-2nnn-subroutines)
...
### `3XNN`, `4XNN`, `5XY0` and `9XY0`: Skip conditionally[](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#3xnn-4xnn-5xy0-and-9xy0-skip-conditionally)
...
### `6XNN`: Set[](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#6xnn-set)

Simply set the register `VX` to the value `NN`.

### `7XNN`: Add[](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#7xnn-add)
...
### [Logical and arithmetic instructions](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#logical-and-arithmetic-instructions)
...
## [Troubleshooting](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#troubleshooting)
...
## [What next](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#what-next)
...
### [Make your own CHIP-8 game!](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#make-your-own-chip-8-game)
...
### [Add SUPER-CHIP support](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#add-super-chip-support)
...
### [Add debug capabilities](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#add-debug-capabilities)
...
### [Make a CHIP-8 emulator for an obscure system](https://tobiasvl.github.io/blog/write-a-chip-8-emulator/#make-a-chip-8-emulator-for-an-obscure-system)
